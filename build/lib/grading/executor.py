...
DEFAULT_GRADING_PROMPT = """You are an expert evaluator tasked with grading a solution against a specific criterion.
...
**Instructions:**
1. Carefully read the criterion description
2. Analyze the solution to determine if it meets the criterion
3. Respond with a JSON object in this exact format:

{{
  "result": 1,
  "reason": "Brief explanation of why the criterion is met or not met"
}}

- Use "result": 1 if the criterion is MET
- Use "result": 0 if the criterion is NOT MET
